...
layui.use(['jquery', 'form'], function () {
        ...
        this.load = function (url, data, method, callback, loading, tips, time, headers) {
            ...
            $.ajax({
                data: data || {}, type: method || 'GET', url: $.menu.parseUri(url), beforeSend: function (xhr) {
                    ...
                    console.log((typeof ret), 'ret object', 'xgk-1', ret);
    ...
    $.fn.uploadOneImage = function () {
        var name = $(this).attr('name') || 'image', type = $(this).data('type') || 'png,jpg,gif,jpeg';
    ...
    $.fn.uploadMultipleImage = function () {
        var type = $(this).data('type') || 'png,jpg,gif,jpeg', name = $(this).attr('name') || 'umt-image';
    ...
    $body.on('click', '[data-modal]', function () {
        return $.form.modal($(this).attr('data-modal'), 'open_type=modal', $(this).attr('data-title') || $(this).text() || '编辑', '', '', '', [$(this).attr('data-area-w') || "400px", $(this).attr('data-area-h') || "400px"]);
    });
